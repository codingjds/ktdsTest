				...
				<div class="grid-detail">
					<form id="detail_form" >
						...
						<div class="input-group inline">
							<label for="gnrId" style="width: 180px;">장르 ID</label><input type="text" id="gnrId"  name="mbrId" value="" readonly />
						</div>
						<div class="input-group inline">
							<label for="gnrNm" style="width: 180px;">장르명</label><input type="text" id="gnrNm"  name="mbrNm" value=""/>
						</div>
						<div class="input-group inline">
