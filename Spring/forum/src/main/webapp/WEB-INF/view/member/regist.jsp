...
/*			
			...
			console.log( dupEmail.css("display") );
			var dupStatus = dupEmail.css("display");
			// 이미 사용중인 이메일입니다. 가 노출중인 경우는 아무일도 하지 않는다.
			if(dupStatus == "inline"){
				alert("이미 사용중인 이메일입니다! 다른 이메일을 입력하세요!")
			}
			// 이미 사용중인 이메일입니다. 가 숨겨진 경우에만 등록을 진행한다ㅏ.
...
<body>
	<h1>회원가입을 환영합니다!</h1>
	<form id="regist_form">	<!-- <form action="${pageContext.request.contextPath}/member/regist" method="post"> -->
		<div>
