...
public class Store {
	...
	public void checkQuantity() {
		...
		// 재고가 2개이상인 경우: "물건명" 제품은 재고가 8개 있습니다.
		// 재고가 0개인 경우: "물건명" 제품은 품절되었습니다.
		// 재고가 1개인 경우: "물건명" 제품은 재고가 1개 있습니다. 재주문이 필요합니다.
		// 물건명
		...
		// if~else if~else
		/*
		 * if(조건 혹은 boolean){ 조건 혹은 boolean의 결과가 true일 경우 실행할 코드 } else if(조건 혹은
		 * boolean){ 조건 혹은 boolean의 결과가 true일 경우 실행할 코드 } else{ 조건 혹은 boolean의 결과가false일
		 * 경우 실행할 코드 }
		 */
		...
		/*
		 * 내가 한거 boolean outOfStock = productQuantity == 0; if(outOfStock) {
		 * System.out.println(productName+ " 제품은"+ " 품절되었습니다."); }
		 * 
		 * boolean needOrder = productQuantity == 1; if(needOrder) {
		 * System.out.println(productName+ " 제품은 재고가 "+productQuantity+
		 * "개 있습니다. 재주문이 필요합니다."); }
		 * 
		 * boolean check = productQuantity >=2; if(check) {
